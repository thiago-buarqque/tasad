...
def train_on_device(args):
    ...
    for class_name in args.class_name:
        ...
        print("Number of parmeters of ReconstructiveSubNetwork: ", cas_params, " million")
            ...
            for i_batch, batch in enumerate(dataloader):
                ...
                if args.visualize and n_iter % 400 == 0:
                    ...
                    try:
                        ...
                        results_val             = subprocess.check_output(f'python3 ./main/test_seg_model.py --gpu_id {args.gpu_id_validation} --model_name  {base_model_name} --data_path {args.data_path} --checkpoint_path {args.checkpoint_path} --both_model 0 --obj_list_all {class_name}', shell=True)
